    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-6 offset-lg-3 col-md-10 offset-md-1 col-12">
                <form class="card login-form"  action="{{url('customer/login')}}" method="post">
                    @csrf
                    <div class="card-body">
                        <div class="title">
                            <h3>Login Now</h3>
                        ...
                        <div class="social-login">
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-md-4 col-12"><a class="btn google-btn"
                                                                         href="{{url('admin/google/auth/redirect')}}"><i class="lni lni-google"></i> Google login</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="d-flex flex-wrap justify-content-between bottom-content">
                            ...
                            <a class="lost-pass" href="{{route('password.request',['local'=>\Illuminate\Support\Facades\App::getLocale()])}}">Forgot password?</a>
                        </div>
                        <div class="button">
